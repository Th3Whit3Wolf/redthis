...
export default function Header() {
	return (
		<header class="fixed inset-0 z-50 flex h-12 bg-white dark:bg-slate-700 select-none">
			<div class="flex flex-1 grow items-center space-x-4 border-b border-grey-lightest px-5">
				<div class="flex grow items-center space-x-4 h-full">
					<Logo />
					<SearchBar />
				</div>
